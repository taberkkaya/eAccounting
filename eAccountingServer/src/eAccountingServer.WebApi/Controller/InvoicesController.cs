using eAccountingServer.Application.Features.Invoices;
...
/// <summary>Satış ve alış faturaları.</summary>
public class InvoicesController : ApiController
{
    ...
    [HttpPost]
    public async Task<IActionResult> GetById(GetInvoiceByIdQuery request, CancellationToken cancellationToken)
    {
        var response = await _mediator.Send(request, cancellationToken);
        return StatusCode(response.StatusCode, response);
    }
    ...
    [HttpPost]
    public async Task<IActionResult> GetNextNumber(GetNextInvoiceNumberQuery request, CancellationToken cancellationToken)
    {
        var response = await _mediator.Send(request, cancellationToken);
        return StatusCode(response.StatusCode, response);
    }
